...
function injectedIndex() {
  ...
  html = html.replace(
    ...
    '<button class="tab" type="button" data-tab="moderator"><img class="tab-icon" src="/CoinSprite/images/moderator.png?v=custom-icons-7" alt="" aria-hidden="true"><span>Moderator</span></button>\n        <button class="tab" type="button" data-tab="messages"><img class="tab-icon" src="/CoinSprite/images/message.png?v=custom-icons-7" alt="" aria-hidden="true"><span>Messages</span></button>\n        <button class="tab" type="button" data-tab="games"><span>Games</span></button>',
  );
  html = html.replace(
