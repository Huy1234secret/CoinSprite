...
function injectedIndex() {
  ...
  html = html.replace(
    ...
    '<button class="tab" type="button" data-tab="moderator"><img class="tab-icon" src="https://raw.githubusercontent.com/Huy1234secret/CoinSprite/main/images/moderator.png" alt="" aria-hidden="true"><span>Moderator</span></button>\n        <button class="tab" type="button" data-tab="messages"><img class="tab-icon" src="https://raw.githubusercontent.com/Huy1234secret/CoinSprite/main/images/message.png" alt="" aria-hidden="true"><span>Messages</span></button>\n        <button class="tab" type="button" data-tab="games"><span>Games</span></button>',
  );
  html = html.replace(
