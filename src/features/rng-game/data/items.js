...
const ITEMS = Object.freeze([
  item({
    ...
    rarity: 'Secret', type: 'Mushroom', price: 6_000_000, durationMs: HOUR_MS,
    affectedRolls: 720, description: 'Secret crop chance +0.025 percentage points; not multiplied by Luck',
  ...
  item({
    ...
    rarity: 'Super', type: 'Mushroom', price: 1_000_000, durationMs: 30 * MINUTE_MS,
  ...
  item({
    ...
    rarity: 'Mythic', type: 'Mushroom', price: 500_000, durationMs: 30 * MINUTE_MS,
  ...
  item({
    ...
    rarity: 'Legendary', type: 'Mushroom', price: 350_000, durationMs: 30 * MINUTE_MS,
  ...
  item({
    ...
    rarity: 'Epic', type: 'Mushroom', price: 75_000, durationMs: 30 * MINUTE_MS,
  ...
  item({
    ...
    rarity: 'Rare', type: 'Mushroom', price: 15_000, durationMs: 30 * MINUTE_MS,
  ...
  item({
    ...
    rarity: 'Super', type: 'Sprinkler', price: 1_500_000, durationMs: 30 * MINUTE_MS,
  ...
  item({
    ...
    rarity: 'Legendary', type: 'Sprinkler', price: 750_000, durationMs: 30 * MINUTE_MS,
  ...
  item({
    ...
    rarity: 'Rare', type: 'Sprinkler', price: 250_000, durationMs: 30 * MINUTE_MS,
  ...
  item({
    ...
    rarity: 'Uncommon', type: 'Sprinkler', price: 75_000, durationMs: 30 * MINUTE_MS,
  ...
  item({
    ...
    rarity: 'Common', type: 'Sprinkler', price: 25_000, durationMs: 30 * MINUTE_MS,
  ...
  item({
    ...
    rarity: 'Super', type: 'Watering Can', price: 100_000, durationMs: 0,
  ...
  item({
    ...
    rarity: 'Common', type: 'Watering Can', price: 5_000, durationMs: 0,
  ...
  item({
    ...
    rarity: 'Common', type: 'Egg', price: 2_000_000, durationMs: 0,
