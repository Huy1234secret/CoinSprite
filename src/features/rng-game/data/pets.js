...
const PETS = Object.freeze([
  ...
  pet({ id: 'butterfly', displayName: 'Butterfly', emoji: '<:ButterflyPet:1537702939211206747>', rarity: 'Legendary', hatchWeight: 100, chanceText: '1', perk: 'BIG crop chance +0.35 percentage points', animation: 'LButterfly.gif', effect: { kind: 'big', bigBonusBps: 35 } }),
