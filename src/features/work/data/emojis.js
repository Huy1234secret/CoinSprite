...
const PIPE_EMOJIS = Object.freeze({
  ...
  ne: emoji('CSPipe2', '1545109101409730620'),
  es: emoji('CSPipe21', '1545125911722983435'),
  sw: emoji('CSPipe22', '1545125914109546556'),
  wn: emoji('CSPipe23', '1545125916009828453'),
...
module.exports = { BURGER_EMOJIS, PIPE_EMOJIS, TRASH_EMOJIS };
