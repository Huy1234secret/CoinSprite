...
const WORK_INGREDIENTS = Object.freeze({
  ...
  cheese: '<:cheese:1537045258838478848>',
...
const CUSTOMER_DEFINITIONS = [
  { id: 1, difficulty: 'easy', reward: 1, message: 'Just beef between the buns, please!', order: ['bunbottom', 'beef', 'buntop'] },
  { id: 2, difficulty: 'easy', reward: 4, message: 'Just cheese between the buns for me!', order: ['bunbottom', 'cheese', 'buntop'] },
  { id: 3, difficulty: 'easy', reward: 7, message: 'Beef first, then ketchup, and finish with the top bun.', order: ['bunbottom', 'beef', 'ketchup', 'buntop'] },
  { id: 4, difficulty: 'easy', reward: 9, message: 'Put cheese on the bottom, then cucumber above it.', order: ['bunbottom', 'cheese', 'cucumber', 'buntop'] },
  { id: 5, difficulty: 'easy', reward: 12, message: 'I’ll have lettuce, beef, and onion in that order.', order: ['bunbottom', 'lettuce', 'beef', 'onion', 'buntop'] },
  { id: 6, difficulty: 'easy', reward: 15, message: 'Give me beef, cheese, and another beef patty, please!', order: ['bunbottom', 'beef', 'cheese', 'beef', 'buntop'] },
  {
    id: 7, difficulty: 'medium', reward: 8,
  ...
  {
    id: 8, difficulty: 'medium', reward: 12,
  ...
  {
    id: 9, difficulty: 'medium', reward: 17,
  ...
  {
    id: 10, difficulty: 'medium', reward: 21,
  ...
  {
    id: 11, difficulty: 'medium', reward: 26,
  ...
  {
    id: 12, difficulty: 'medium', reward: 30,
  ...
  {
    id: 13, difficulty: 'hard', reward: 15,
  ...
  {
    id: 14, difficulty: 'hard', reward: 20,
  ...
  {
    id: 15, difficulty: 'hard', reward: 25,
  ...
  {
    id: 16, difficulty: 'hard', reward: 30,
  ...
  {
    id: 17, difficulty: 'hard', reward: 35,
  ...
  {
    id: 18, difficulty: 'hard', reward: 40,
  ...
  {
    id: 19, difficulty: 'hard', reward: 45,
  ...
  {
    id: 20, difficulty: 'hard', reward: 50,
