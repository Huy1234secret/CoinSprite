...
const DEFAULT_DATABASE_PATH = path.join(__dirname, '..', '..', '..', '..', 'data', 'work.sqlite');
...
function openDatabase(options = {}) {
  const databasePath = options.databasePath || process.env.WORK_DATABASE_PATH || DEFAULT_DATABASE_PATH;
