...
const DEFAULT_BOT_TEMPLATES = Object.freeze([
  ...
  {
    id: 'default-appeal-accepted-notice',
    type: 'template',
    folderId: '',
    name: 'Default: Appeal accepted notice',
    content: '',
    containers: [{
      id: 'appeal-accepted-notice',
      accentColor: '#57F287',
      text: [
        '## Appeal accepted',
        'Your appeal for case **<case-id>** in **<server-name>** was accepted.',
        '**Appeal:** <appeal-id>',
        '**Reviewer:** <reviewer>',
        '**Reviewer note:** <reviewer-note>',
        '<separator>',
        '**View the decision:** <appeal-url>',
        '-# The moderation action was resolved after staff review.',
      ].join('\n'),
      thumbnailUrl: '<avatar_url>',
      imageUrl: '',
    }],
  ...
  {
    id: 'default-appeal-denied-notice',
    type: 'template',
    folderId: '',
    name: 'Default: Appeal denied notice',
    content: '',
    containers: [{
      id: 'appeal-denied-notice',
      accentColor: '#ED4245',
      text: [
        '## Appeal denied',
        'Your appeal for case **<case-id>** in **<server-name>** was denied.',
        '**Appeal:** <appeal-id>',
        '**Reviewer:** <reviewer>',
        '**Reviewer note:** <reviewer-note>',
        '<separator>',
        '**View the decision:** <appeal-url>',
        '-# Review the staff decision before submitting another appeal.',
      ].join('\n'),
      thumbnailUrl: '<avatar_url>',
      imageUrl: '',
    }],
...
;(function installConsolidatedCommandFixes() {
  ...
  const fixes = [
    ["000z-message-template-extra-defaults.js", function (module, exports, require, __filename, __dirname) {
'use strict';
...
const EXTRA_DEFAULT_BOT_TEMPLATES = Object.freeze([
  ...
  makeDefaultTemplate({
    ...
    lines: [
      ...
      '<separator>',
      '-# Review the server rules before chatting again.',
    ],
  }),
  makeDefaultTemplate({
    id: 'default-moderation-kick-notice',
    name: 'Default: Manual kick notice',
    accentColor: '#ED4245',
    thumbnailUrl: '<avatar_url>',
    lines: [
      '## You were kicked',
      ...
      '**Appealable:** <appealable-status>',
      '<separator>',
      '-# You may rejoin unless staff has told you otherwise.',
    ],
  }),
  makeDefaultTemplate({
    id: 'default-moderation-ban-notice',
    name: 'Default: Manual ban notice',
    accentColor: '#ED4245',
    thumbnailUrl: '<avatar_url>',
    lines: [
      '## You were banned',
      ...
      '**Appealable:** <appealable-status>',
      '<separator>',
      '-# Use the official appeal process only when this action is appealable.',
    ],
  }),
  makeDefaultTemplate({
