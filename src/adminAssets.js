...
function loadAdminAsset(filename) {
  if (!['document', 'emojiData.js', 'app.js', 'inventory.js', 'ui.css', 'brand-icon.png'].includes(filename)) return null;
  try {
    ...
    if (filename === 'document') {
      ...
      const assetNames = ['ui.css', 'emojiData.js', 'app.js', 'inventory.js'];
