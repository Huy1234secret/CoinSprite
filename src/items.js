...
const ITEMS = [
  ...
  },
  {
    id: 'ITAdminPickaxe',
    name: 'Admin Pickaxe',
    emoji: '<:ITADP:1460896136490385550>',
  ...
  },
  {
    id: 'ITBasaltIron',
    name: 'Basalt Iron',
    emoji: '<:ITBasaltIron:1460832573633855539>',
    image: 'https://i.ibb.co/3yPFN5L1/ITBasalt-Iron.png',
    rarity: 'Epic',
    type: 'Material',
    value: 650,
    sellPrice: 650,
    tradable: true,
    durability: null,
    info: 'Dense iron infused with basalt.',
    obtainment: 'Obtainment: Found while mining deep layers 151+.',
    usage: 'Usage: Currently no special function beyond collection and trading.',
  },
  {
    id: 'ITMagmaCore',
    name: 'Magma Core',
    emoji: '<:ITMagmaCore:1460832576532123760>',
    image: 'https://i.ibb.co/9mmZ2R8c/ITMagma-Core.png',
    rarity: 'Legendary',
    type: 'Material',
    value: 2000,
    sellPrice: 2000,
    tradable: true,
    durability: null,
    info: 'A blazing core extracted from molten rock.',
    obtainment: 'Obtainment: Found while mining very deep layers 501+.',
    usage: 'Usage: Currently no special function beyond collection and trading.',
  },
  {
    id: 'ITMagmaticOre',
    name: 'Magmatic Ore',
    emoji: '<:ITMagmaticOre:1460832579782709352>',
    image: 'https://i.ibb.co/FbmpKC3h/ITMagmatic-Ore.png',
    rarity: 'Legendary',
    type: 'Material',
    value: 1500,
    sellPrice: 1500,
    tradable: true,
    durability: null,
    info: 'Superheated ore forged in magma flows.',
    obtainment: 'Obtainment: Found while mining very deep layers 501+.',
    usage: 'Usage: Currently no special function beyond collection and trading.',
  },
  {
    id: 'ITSulfurClumps',
    name: 'Sulfur Clumps',
    emoji: '<:ITSulfurClumps:1460832585369522351>',
    image: 'https://i.ibb.co/5x20t3qw/ITSulfur-Clumps.png',
    rarity: 'Epic',
    type: 'Material',
    value: 830,
    sellPrice: 830,
    tradable: true,
    durability: null,
    info: 'Bright yellow clumps with a sharp scent.',
    obtainment: 'Obtainment: Found while mining very deep layers 501+.',
    usage: 'Usage: Currently no special function beyond collection and trading.',
  },
  {
    id: 'ITObsidian',
    name: 'Obsidian',
    emoji: '<:ITObsidian:1460832582236111013>',
    image: 'https://i.ibb.co/Q3bWNBfj/ITObsidian.png',
    rarity: 'Epic',
    type: 'Material',
    value: 700,
    sellPrice: 700,
    tradable: true,
    durability: null,
    info: 'A glossy volcanic glass formed by rapid cooling.',
    obtainment: 'Obtainment: Found while mining deep layers 151+.',
    usage: 'Usage: Currently no special function beyond collection and trading.',
  },
  {
