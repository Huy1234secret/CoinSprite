...
A simple Discord bot that provides a `/roll` command to award 10$ giftcards based on a 1% chance and announces remaining prizes.
...
## Notes
- Update `TOTAL_GIFTCARDS` and `ANNOUNCEMENT_CHANNEL_ID` in `src/bot.py` to fit your event specifics.
